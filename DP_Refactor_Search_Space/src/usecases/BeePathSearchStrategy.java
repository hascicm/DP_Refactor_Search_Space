...
//REFACTOR - Large Class
 ...
 public class BeePathSearchStrategy extends PathSearchStrategy {
  ...
  // smelltag end   : FE21 //SMELL: #SmellType(Feature Envy)
 //REFACTOR - Long Method
  ...
  // smelltag end   : MAGIC14 //SMELL: #SmellType(Magic Numbers)
 0// smelltag start : MAGIC14 ));
	...
	//REFACTOR - Feature Envy
  // smelltag end   : FE22 //SMELL: #SmellType(Feature Envy)
 private void calculateProbabilityForRecruit(List<Bee> employeeBees) {
  ...
  // smelltag end   : MAGIC15 //SMELL: #SmellType(Magic Numbers)
 2// smelltag start : MAGIC15 );
			}else{
				
				if(employeeBees.indexOf(b) < ((employeeBees.size()/4) * 3)){
					b.setNumForRecruit(//REFACTOR - Magic Number
  // smelltag end   : MAGIC16 //SMELL: #SmellType(Magic Numbers)
 1// smelltag start : MAGIC16 );
				}else{
					b.setNumForRecruit(//REFACTOR - Magic Number
  // smelltag end   : MAGIC17 //SMELL: #SmellType(Magic Numbers)
 0// smelltag start : MAGIC17 );
				}
  ...
  // smelltag end   : MAGIC18 //SMELL: #SmellType(Magic Numbers)
 1.0// smelltag start : MAGIC18 );
		}
	}
  ...
  // smelltag end   : MAGIC19 //SMELL: #SmellType(Magic Numbers)
 0// smelltag start : MAGIC19 );
  ...
  private void exploreSpace(Bee bee, State state, int depth){
	...
	//REFACTOR - Feature Envy
  // smelltag end   : FE23 //SMELL: #SmellType(Feature Envy)
