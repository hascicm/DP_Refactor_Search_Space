...
public class BasicDataProvider implements DataProvider{
	...
	public BasicDataProvider(){
		...
		DependencyRepair repair_1 = new DependencyRepair("Repair_1", r1_smells);
		repair_1.addDependency(DependencyType.CAUSE, smell_2);
		repair_1.addDependency(DependencyType.CAUSE, smell_3);
		repair_1.addDependency(DependencyType.SOLVE, smell_4);
		...
		this.root.getSmells().add(new SmellOccurance(smell_4));
